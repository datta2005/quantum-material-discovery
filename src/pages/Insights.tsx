    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container py-8 space-y-8">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Machine learning predictions and optimization recommendations</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-card rounded-xl border border-border p-6 space-y-4">
            ...
            <div className="h-2 rounded-full bg-muted overflow-hidden">
              <div className="h-full w-[92%] rounded-full bg-gradient-to-r from-success to-quantum" />
            </div>
          </div>
          ...
          <div className="bg-card rounded-xl border border-border p-6 space-y-4">
            ...
            <div className="h-2 rounded-full bg-muted overflow-hidden">
              <div className="h-full w-[94.6%] rounded-full bg-gradient-to-r from-accent to-quantum" />
            </div>
          </div>
          ...
          <div className="bg-card rounded-xl border border-border p-6 space-y-4">
            ...
            <div className="h-2 rounded-full bg-muted overflow-hidden">
              <div className="h-full w-[15%] rounded-full bg-warning" />
            </div>
          </div>
        </div>
        ...
        <div className="bg-card rounded-xl border border-border p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[
              { icon: Shield, title: "Defense Systems", desc: "High stability and thermal resistance make this material ideal for aerospace and military applications.", score: 9.4 },
              { icon: Zap, title: "Energy Storage", desc: "Exceptional conductivity suggests strong performance in next-generation battery technologies.", score: 9.1 },
              { icon: Lightbulb, title: "Electronics", desc: "Band gap properties suitable for advanced semiconductor applications.", score: 8.7 },
            ].map((app, i) => (
        ...
        <div className="bg-gradient-to-r from-accent/10 via-quantum/5 to-accent/10 rounded-xl border border-accent/20 p-6 space-y-4">
          ...
          <div className="p-4 rounded-lg bg-card/50 border border-border/50">
            <p className="text-foreground leading-relaxed">
              This material demonstrates <span className="font-semibold text-success">exceptional stability</span> (9.2/10) and 
              <span className="font-semibold text-accent"> high conductivity</span> (8.9/10), making it particularly suitable for 
              <span className="font-semibold"> defense-grade energy storage systems</span>. The quantum simulation indicates 
              a favorable band structure with minimal thermal degradation up to 1,200°C. 
              <span className="font-semibold text-quantum"> Recommended for immediate prototyping</span> in next-generation 
          ...
          <div className="flex gap-3">
            ...
            <div className="px-3 py-1.5 rounded-full bg-quantum/10 text-quantum text-sm font-medium">
              Quantum Verified
            </div>
          </div>
        </div>
